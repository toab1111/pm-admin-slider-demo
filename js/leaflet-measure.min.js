...
! function(e) {
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _getMeasurementDisplayStrings: function(e) {
            ...
            function r(e, t, r, n) {
                var o = { acres: "Acres", feet: "Feet", kilometers: "กิโลเมตร", hectares: "Hectares", meters: "เมตร", miles: "Miles", sqfeet: "Sq Feet", sqmeters: "ตารางเมตร", sqmiles: "Sq Miles" },
...
}, function(e, t, r) { e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="วัดระยะทางและพื้นที่">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>วัดระยะทางและพื้นที่</h3> <ul class=tasks> <a href=# class="js-start start">สร้างการวัดครั้งใหม่</a> </ul> </div> <div class=js-measuringprompt> <h3>วัดระยะทางและพื้นที่</h3> <p class=js-starthelp>เริ่มต้นการวัดโดยเพิ่มจุดลงบนแผ่นที่</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">ยกเลิก</a></li> <li><a href=# class="js-finish finish">เสร็จสิ้นการวัด</a></li> </ul> </div> </div> ' }, function(e, t, r) { e.exports = '<div class=group> <p class="lastpoint heading">จุดสุดท้าย</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>ระยะทาง</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>พื้นที่</span> {{ model.areaDisplay }}</p> </div> <% } %> ' }, function(e, t, r) { e.exports = '<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this location</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h3>Linear measurement</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this line</a></li> <li><a href=# class="js-deletemarkup deletemarkup">ลบ</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h3>การวัดพื้นที่</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} เส้นรอบรูป</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">จุดศูนย์กลางของพื้นที่</a></li> <li><a href=# class="js-deletemarkup deletemarkup">ลบ</a></li> </ul> ' }]);